...
def chamar_bedrock() -> dict:
    ...
    # Mensagem do usuário para a API de conversação
    user_message = "Por favor, me diga o que aconteceu de errado com a requisição ao ViaCEP?"
